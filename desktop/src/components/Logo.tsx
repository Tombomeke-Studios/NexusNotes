interface LogoProps {
   ...
   * dark: dark nodes for placement on a gradient background (auth card)
  ...
  if (variant === "dark") {
    return (
      <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g stroke="#11111b" strokeWidth="1.6" opacity="0.5" strokeLinecap="round">
          <line x1="10" y1="8" x2="10" y2="24" />
          <line x1="10" y1="8" x2="22" y2="24" />
          <line x1="22" y1="8" x2="22" y2="24" />
        </g>
        <circle cx="10" cy="8" r="3" fill="#11111b" />
        <circle cx="10" cy="24" r="3" fill="#11111b" />
        <circle cx="22" cy="8" r="3" fill="#11111b" />
        <circle cx="22" cy="24" r="3" fill="#11111b" />
        <circle cx="16" cy="16" r="3.5" fill="#11111b" />
        <circle cx="16" cy="16" r="1.4" fill="#cba6f7" />
      </svg>
    );
  }
