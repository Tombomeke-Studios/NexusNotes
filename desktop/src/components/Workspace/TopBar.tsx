    ...
    <>
      ...
      <div className="win-controls">
        ...
        <button className="win-btn" onClick={call("toggleMaximize")} title={maximized ? "Restore" : "Maximize"}>
          <svg width="11" height="11" viewBox="0 0 11 11" fill="none">
            {maximized ? (
              <path d="M3.6 3.6h5.2v5.2H3.6z M2.2 7V2.2H7" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round" fill="none" />
            ) : (
              <path d="M2.2 2.2h6.6v6.6H2.2z" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round" fill="none" />
            )}
          </svg>
        </button>
